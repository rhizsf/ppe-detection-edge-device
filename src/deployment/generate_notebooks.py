     ...
     "cells": [
      {
       ...
       "metadata": {},
       "source": [
        "# PROTMIND — Model Training Notebook\n",
        "Notebook ini digunakan untuk melatih model deteksi kepatuhan APD secara interaktif mulai dari pengecekan dataset, prapemrosesan gambar cropped, hingga menjalankan training YOLOv8."
       ]
      },
      {
       "cell_type": "code",
       ...
       "source": [
        ...
        "print(\"Modul pelatihan berhasil dimuat!\")"
       ]
      },
      {
       "cell_type": "markdown",
       "metadata": {},
       "source": [
        "### 1. Pengecekan Kesiapan Dataset\n",
        "Jalankan cell di bawah untuk memverifikasi file YAML dan struktur folder dataset asli Anda."
       ]
      },
      {
       "cell_type": "code",
      ...
      },
      {
       ...
       "metadata": {},
       "source": [
        "### 2. Prapemrosesan Dataset (Cropping & Augmentasi)\n",
        "Proses ini memotong objek orang (Stage 1) dan menyiapkannya untuk pelatihan deteksi APD (Stage 2)."
       ]
      },
      {
       "cell_type": "code",
       ...
       "outputs": [],
       "source": [
        "# Jalankan pembuatan cropped dataset\n",
      ...
      },
      {
       ...
       "metadata": {},
       "source": [
        "### 3. Jalankan Pelatihan Model APD\n",
        "Jalankan cell di bawah untuk memulai proses pelatihan model APD (Stage 2) menggunakan YOLOv8."
       ]
      },
      {
       "cell_type": "code",
       ...
       "outputs": [],
       "source": [
        "# Mulai proses pelatihan (contoh: 10 epoch untuk uji coba)\n",
        "run_training(epochs=10, resume=False)"
       ]
      }
     ],
     "metadata": {
